...
| 조건 | MAE ↓ | SSIM ↑ | LPIPS ↓ |
| --- | --- | --- | --- |
| 한 번에 편집 | 0.071072 [0.070024, 0.072121] | 0.871627 [0.867801, 0.875453] | 0.080452 [0.076626, 0.084277] |
| 세 번 나눠 편집 | 0.104262 [0.100540, 0.107984] | 0.773369 [0.772179, 0.774559] | 0.110930 [0.108115, 0.113745] |
| 무변경 3회 재생성 | 0.036392 [0.034768, 0.038016] | 0.806760 [0.784794, 0.828726] | 0.062738 [0.060205, 0.065270] |

두 반복 각각에서도 batch의 MAE·LPIPS가 더 낮고 SSIM이 더 높았다. batch의 평균 LPIPS는 sequential보다 27.5% 낮았다. **이를 “피부 열화가 27.5% 감소했다”로 해석하면 안 된다.** ROI는 피부만의 마스크가 아니며 머리·경계·배경 일부를 포함한다.

| 조건 | 반복 | MAE | SSIM | LPIPS |
| --- | --- | --- | --- | --- |
| 한 번에 편집 | 1 | 0.070024 | 0.867801 | 0.084277 |
| 한 번에 편집 | 2 | 0.072121 | 0.875453 | 0.076626 |
| 세 번 나눠 편집 | 1 | 0.107984 | 0.772179 | 0.113745 |
| 세 번 나눠 편집 | 2 | 0.100540 | 0.774559 | 0.108115 |
| 무변경 3회 재생성 | 1 | 0.038016 | 0.828726 | 0.065270 |
| 무변경 3회 재생성 | 2 | 0.034768 | 0.784794 | 0.060205 |

## 단계별 원본 거리와 직전 입력 거리

각 값은 조건 내 두 경로의 평균이다. 두 종류의 거리를 더하거나 빼서 순수 열화량으로 만들지 않는다.

| 조건 | 단계 | 원본 MAE | 원본 SSIM | 원본 LPIPS | 직전 MAE | 직전 SSIM | 직전 LPIPS |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 한 번에 편집 | 1 | 0.071072 | 0.871627 | 0.080452 | 0.071072 | 0.871627 | 0.080452 |
| 세 번 나눠 편집 | 1 | 0.024078 | 0.894790 | 0.024209 | 0.024078 | 0.894790 | 0.024209 |
| 세 번 나눠 편집 | 2 | 0.105629 | 0.813547 | 0.100077 | 0.107919 | 0.856430 | 0.085462 |
| 세 번 나눠 편집 | 3 | 0.104262 | 0.773369 | 0.110930 | 0.019112 | 0.944307 | 0.012729 |
| 무변경 3회 재생성 | 1 | 0.017203 | 0.901098 | 0.020250 | 0.017203 | 0.901098 | 0.020250 |
| 무변경 3회 재생성 | 2 | 0.027682 | 0.844320 | 0.041245 | 0.016254 | 0.932153 | 0.017633 |
| 무변경 3회 재생성 | 3 | 0.036392 | 0.806760 | 0.062738 | 0.015470 | 0.948439 | 0.015616 |
...
| --- | --- | --- | --- |
| 한 번에 편집 | 0.071072 [0.070024, 0.072121] | 0.871627 [0.867801, 0.875453] | 0.080452 [0.076626, 0.084277] |
| 세 번 나눠 편집 | 0.104120 [0.100540, 0.107699] | 0.771282 [0.768005, 0.774559] | 0.111658 [0.108115, 0.115200] |
| 무변경 3회 재생성 | 0.034418 [0.030664, 0.038173] | 0.818576 [0.818235, 0.818918] | 0.060513 [0.054173, 0.066854] |
...
| 조건 | 피부 MAE ↓ | 피부 SSIM ↑ | 피부 고주파 MAE ↓ |
| --- | --- | --- | --- |
| 한 번에 편집 | 0.019889 [0.017415, 0.022364] | 0.836704 [0.833759, 0.839649] | 0.012536 [0.012343, 0.012729] |
| 세 번 나눠 편집 | 0.032031 [0.031542, 0.032519] | 0.775373 [0.768171, 0.782576] | 0.014595 [0.014396, 0.014795] |
| 무변경 3회 재생성 | 0.028938 [0.024914, 0.032962] | 0.791713 [0.783320, 0.800105] | 0.013837 [0.013753, 0.013920] |
