import allCandidates from '@/app/followup-survey/data.json';
const candidates = allCandidates.filter(c => ['03ab8e563fdaf444', '28b61976b7c73505'].includes(c.id));
export { candidates };
export const SCHEMA = 'followup-face-recheck-v1';
export const AGES = [
  '19세 이하',
  '20대',
  '30대',
...
export function validSubmission(d: Submission): boolean {
  ...
  if (
    ...
    !d.answers ||
    Object.keys(d.answers).length !== candidates.length
  )
    return false;
